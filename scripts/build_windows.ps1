...
Write-Host "[2/4] Building Python backend sidecar via PyInstaller..." -ForegroundColor Cyan
...
# -- 2. Tauri bundle ----------------------------------------------
Write-Host "[3/4] Installing UI dependencies..." -ForegroundColor Cyan
Push-Location ui
npm install | Out-Null

Write-Host "[4/4] Building Tauri installer (this takes ~10 min on a clean cache)..." -ForegroundColor Cyan
npm run tauri:build
